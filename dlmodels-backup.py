...
models = [
    Model(
        ...
        url='https://www.monoxit.com/storage/ai101on/ssd_mobilenet_v1_coco_2017_11_17.pb',
        sha='9e4bcdd98f4c6572747679e4ce570de4f03a70e2',
        filename='frozen_inference_graph.pb'),
    Model(
        name='MobileNet-SSD v1 (pbtxt)',
        url='https://www.monoxit.com/storage/ai101on/ssd_mobilenet_v1_coco_2017_11_17.pbtxt',
